...
namespace Drupal\impact\Plugin\Layout\Teasers;
...
/**
 * A  teaser for Hero : impact module 
 * 
 * @Layout(
...
class ImpactHeroTeaser extends FormatageModelsTeasers {
    ...
    public function __construct(array $configuration, $plugin_id, $plugin_definition, StylesGroupManager $styles_group_manager) {
        ...
        $this->pluginDefinition->set('icon', $this->pathResolver->getPath('module', 'impact') . "/icones/teasers/impact-hero-teaser.png");
    }
